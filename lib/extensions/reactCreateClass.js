...
module.exports = function reactCreateClass(components, currentName, getCurrent) {
    var current = getCurrent(components);

    // console.log('\nCREATE_CLASS: "' + currentName + '"\n');
    // console.log('_ctx._React: #%s#', JSON.stringify(components, null, 2));
